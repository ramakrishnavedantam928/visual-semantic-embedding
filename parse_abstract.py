...
def get_image_feat(feat_type, image_folder, orig_split, indices):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--imfeat', default='fc7', help='What image features do you want to use?')
    parser.add_argument('--imdir', default='/srv/share/vqa/release_data/abstract_v002/',
                        help='Name of the directory which contains the img_train2015 and img_val2015 folders')
    parser.add_argument('--splits', default='train-dev-test', help="What splits do you want to run feature extraction on?")
    parser.add_argument('--caption_dir', default='../datasets', help='Name of the directory which has the caption files in VQA format')
    parser.add_argument('--seed', default=123, help='Select random seed for splitting val into dev and test')
